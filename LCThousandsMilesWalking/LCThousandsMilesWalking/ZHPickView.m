...
-(instancetype)initPickviewWithPlistName:(NSString *)plistName isHaveNavControler:(BOOL)isHaveNavControler  addPickType:(LC_PICKE_TYPE)pickType{
...
-(instancetype)initPickviewWithArray:(NSArray *)array isHaveNavControler:(BOOL)isHaveNavControler addPickType:(LC_PICKE_TYPE)pickType{
    self=[super init];
    if (self) {
        _pickeType=pickType;
...
-(instancetype)initDatePickWithDate:(NSDate *)defaulDate datePickerMode:(UIDatePickerMode)datePickerMode isHaveNavControler:(BOOL)isHaveNavControler addPickType:(LC_PICKE_TYPE)pickType{
...
-(void)doneClick
{
    ...
    if ([self.delegate respondsToSelector:@selector(toobarDonBtnHaveClick:resultString:addPickType:)]) {
        [self.delegate toobarDonBtnHaveClick:self resultString:_resultString addPickType:_pickeType];
    }
    [self removeFromSuperview];
}
/**
